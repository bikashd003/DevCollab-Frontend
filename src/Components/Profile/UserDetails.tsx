...
const UserDetails = () => {
    ...
    const projects = [
        { title: "Project 1", description: "A web application that helps users manage their tasks and projects." },
        { title: "Project 2", description: "A mobile app that helps users track their fitness goals and progress." },
        { title: "Project 3", description: "A data visualization tool that helps users analyze complex datasets." },
        { title: "Project 4", description: "A content management system that helps users create and manage their websites." },
    ];
    return (
                ...
                <div className="space-y-4">
                    <div className="flex items-start">
                        ...
                        <h2 className="ml-4 text-3xl font-bold text-teal-400">
                            <span className="text-purple-400">const</span> <span className="text-teal-400">Portfolio</span> <span className="text-zinc-300">= () </span>
                    ...
                    <div className="flex items-start">
                        ...
                        <p className="ml-4 text-zinc-400">// Experienced software engineer with a passion for building innovative products.</p>
                    </div>
                </div>
