...
const QuestionCard: React.FC<{ question: Question }> = ({ question }) => (
    <Skeleton isLoaded className="rounded-lg border bg-background text-foreground dark:bg-dark-background dark:text-dark-foreground shadow-sm">
        {/* Question Details */}
        <div className="p-6">
            {/* Author Info */}
            <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                    ...
                    <div className="text-sm text-muted-foreground">{question.postedAt}</div>
                </div>
            </div>
            {/* Question Title */}
            <h3 className="text-lg font-semibold">{question.title}</h3>
            {/* Question Excerpt */}
            <p className="text-sm text-muted-foreground mt-2">{question.excerpt}</p>
            {/* Tags */}
