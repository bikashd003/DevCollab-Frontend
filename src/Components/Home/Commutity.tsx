      ...
      <section className="py-20">
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12 dark:text-dark-foreground text-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  quote:
                    'DevLearn has transformed the way I approach coding. The community support is incredible!',
                  author: 'Sarah J., Full Stack Developer',
                },
                {
                  quote:
                    'The pair programming feature helped me overcome my biggest coding challenges.',
                  author: 'Mike T., Frontend Engineer',
                },
                {
                  quote: 'Thanks to DevLearn, I landed my dream job as a software engineer!',
                  author: 'Emily R., Recent Graduate',
                },
              ].map((item, index) => (
                <Skeleton isLoaded={isLoaded} className="rounded-lg" key={index}>
