...
import { Steps, Input, Tag, Tooltip, message, List } from 'antd';
                            ...
                            {current === 0 && (
                                <div className="mb-4">
                                    ...
                                    <Input
                                        ...
                                        className={`w-full p-2 border rounded-md bg-background dark:bg-dark-background text-foreground dark:text-dark-foreground ${errors.title ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
                                            }`}
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex flex-wrap">
                                        ...
                                        <Input
                                            ...
                                            className={`mr-2 mb-2 bg-background dark:bg-dark-background text-foreground dark:text-dark-foreground border-gray-300 dark:border-gray-700 ${errors.tags ? 'border-red-500' : ''
                                                }`}
                                        />
                                    </div>
                ...
                <div className="bg-background dark:bg-dark-background text-foreground dark:text-dark-foreground p-6 rounded-lg shadow-lg lg:w-1/3">
                    ...
                    <div className="flex flex-wrap">
                        {mostUsedTags.map((tag) => (
                            <Tag key={tag} className="mr-2 mb-2 bg-gray-200 dark:bg-gray-700 text-foreground dark:text-dark-foreground">
                                {tag}
                            </Tag>
                        ))}
                    </div>
                    ...
                    <List
                        ...
                        renderItem={(item) => (
                            <List.Item>
                                <a href="#" className="text-sm font-medium hover:underline underline-offset-4 text-blue-600 dark:text-blue-400">
                                    {item}
                                </a>
                            </List.Item>
                        )}
