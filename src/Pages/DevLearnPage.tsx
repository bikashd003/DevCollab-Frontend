        ...
        <section className="bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800 text-white py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
            ...
            <motion.div
              ...
              className="md:w-1/2"
            >
              <img src="https://placehold.co/600x400" alt="Developers collaborating" className="rounded-lg shadow-lg w-full"/>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <img src="https://placehold.co/100x50" alt="DevLearn Logo" className="h-8"/>
            </div>
            <div className="flex flex-wrap justify-center space-x-4 mb-4 md:mb-0">
              <Link to="#" className="hover:text-blue-400 transition duration-300">About Us</Link>
              <Link to="#" className="hover:text-blue-400 transition duration-300">Contact</Link>
              <Link to="#" className="hover:text-blue-400 transition duration-300">FAQ</Link>
              <Link to="#" className="hover:text-blue-400 transition duration-300">Privacy Policy</Link>
            </div>
            <div className="flex space-x-4">
              <Link to="#" className="hover:text-blue-400 transition duration-300"><i className="fab fa-facebook"></i></Link>
              <Link to="#" className="hover:text-blue-400 transition duration-300"><i className="fab fa-twitter"></i></Link>
              <Link to="#" className="hover:text-blue-400 transition duration-300"><i className="fab fa-linkedin"></i></Link>
              <Link to="#" className="hover:text-blue-400 transition duration-300"><i className="fab fa-github"></i></Link>
            </div>
          </div>
          <div className="mt-8 text-center text-sm">
            &copy; 2023 DevLearn. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
